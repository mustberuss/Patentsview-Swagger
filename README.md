...
[![Build Status](https://travis-ci.org/mustberuss/Patentsview-API.svg?branch=master)](https://travis-ci.org/mustberuss/Patentsview-API)
...
6. If you did everything correct, https://mustberuss.github.io/Patentsview-API/ will lead to your new docs
